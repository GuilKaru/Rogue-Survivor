    ...
    class SelectRaceState : GameState
    {
        ...
        public override void Draw()
        {
            ...
            if (confirmChoice)
            {
                ...
                ui.DrawStringBold(Color.White, string.Format("Race : {0}.", isUndead ? "Undead" : "Living"), gx, gy);
                gy += Ui.BOLD_LINE_SPACING;
        ...
        public override void Update(double dt)
        {
            ...
            switch (key)
            {
                ...
                case Key.Enter:
                    ...
                    {
                        case 0: // random
                            isUndead = game.Session.charGenRoller.RollChance(50);
                            confirmChoice = true;
                            break;
