...
namespace RogueSurvivor.Engine
{
    class RogueGame
    {
        ...
        public Rectangle m_MapViewRect;
        ...
        public int CountLivings(Map map)
        {
            if (map == null)
        ...
        public int CountUndeads(Map map)
        {
            if (map == null)
                throw new ArgumentNullException("map");
        ...
        public int FoodToHoursUntilHungry(int food)
        {
        ...
        public int FoodToHoursUntilRotHungry(int food)
        {
        ...
        public Point MouseToMap(Point mousePosition)
        {
        ...
        public bool IsVisibleToPlayer(Location location)
        {
            return IsVisibleToPlayer(location.Map, location.Position);
        }

        public bool IsVisibleToPlayer(Map map, Point position)
        {
        ...
        public bool IsVisibleToPlayer(Actor actor)
        {
            return actor == m_Player || IsVisibleToPlayer(actor.Location);
        }

        public bool IsVisibleToPlayer(MapObject mapObj)
        {
        ...
        public bool IsKnownToPlayer(MapObject mapObj)
        {
        ...
        public void StopSimThread(bool abort)
        {
